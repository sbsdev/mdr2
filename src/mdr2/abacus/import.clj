...
(defn print-stats
  ...
  (println "------")
  (println (string/join ", " (sort (map :id (filter ready? all-commercial-productions)))))
  (println)
  ...
  (println "----------------------------------------")
  (println (string/join ", " (sort (map :id (filter #(recording-no-wav-with-struct? %) all-commercial-productions)))))
  (println)
  ...
  (println "--------------------------------------")
  (println (string/join ", " (sort (map :id (filter recording-with-obi? all-commercial-productions)))))
  (println)
  (println "Recording with wav and no obi project:" (count (filter recording-with-wav-no-obi? all-commercial-productions)))
  (println "--------------------------------------")
  (println (string/join ", " (sort (map :id (filter recording-with-wav-no-obi? all-commercial-productions)))))
  (println)
  (print "Ignoring the rest: ")
